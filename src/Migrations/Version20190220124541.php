 ...
 */
final class Version20190220124541 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog_post ADD author_id INT NOT NULL, DROP author, CHANGE slug slug VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog_post ADD author VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP author_id, CHANGE slug slug VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
    }
}
